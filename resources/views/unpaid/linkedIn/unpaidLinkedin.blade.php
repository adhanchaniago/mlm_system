...
@section('content')
    <section class="content-header">
        <h1 class="pull-left">Unpaid SamyLinkedin Companies</h1>
        <h1 class="pull-right">
                    ...
                    @foreach($users as $user)
                        ...
                        <tr>
                            ...
                            <td>
                                <div class='btn-group'>
                                    <center>
                                        <a href="{{ url('samy_linkedIn/show'.'/'.$company->id) }}" class='btn btn-default btn-xs'>
                                            <i class="glyphicon glyphicon-eye-open"></i>
                                        </a>
                                        @if($user->link_disabled == 0)
                                            <button type="button" class="btn btn-danger btn-xs" onclick="disableCompany('{{$company->id}}',1,'link_disabled')" title="Suspend User"><i class="fa fa-ban"></i></button>
                                        @else
                                            <button type="button" class="btn btn-success btn-xs" onclick="disableCompany('{{$company->id}}',0,'link_disabled')" title="Enable User"><i class="fa fa-check"></i></button>
                                        @endif
                                    </center>
                                </div>
                            </td>
