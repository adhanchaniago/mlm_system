                ...
                <div class="navbar-collapse collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        @if(Request::is('/') || Request::is('home*'))
                            <li class="active"><a class="home-navigation" href="{{url('home#home')}}">{{trans('header.home')}}</a></li>
                            <li><a class="home-navigation" href="{{url('home#section1')}}">{{trans('header.samy_bot')}}</a></li>
                            <li><a class="home-navigation" href="{{url('home#section2')}}">{{trans('header.samy_affiliate')}}</a></li>
                            <li><a class="home-navigation" href="{{url('home#section3')}}">{{trans('header.contact_us')}}</a></li>
                            ...
                            @else
                                <li><a class="home-navigation" href="{{url('login')}}">{{trans('header.login')}}</a></li>
                            @endif
                            <li class="dropdown">
                        ...
                        @else
                            <li><a class="home-navigation" href="{{url('home')}}">{{trans('header.home')}}</a></li>
                            <li><a class="home-navigation" href="{{url('home#section1')}}">{{trans('header.samy_bot')}}</a></li>
                            <li><a class="home-navigation" href="{{url('home#section2')}}">{{trans('header.samy_affiliate')}}</a></li>
                            <li><a class="home-navigation" href="{{url('home#section3')}}">{{trans('header.contact_us')}}</a></li>
                            @if(Auth::user())
