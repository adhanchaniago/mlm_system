                                    ...
                                    @foreach($sales as $sale)
                                        <center>
                                            <div class="col-md-12 col-sm-12 col-xs-12 affiliate-sales">
                                                ...
                                                <div class="col-md-4 col-sm-4">
                                                    <h5><b>&dollar;{{number_format($sale->amount)}}</b></h5>
                                                </div>
                                            </div>
                                        </center>
                                    @endforeach
                    ...
                    <div class="form-group">
                        <div class="col-md-8 col-xs-12 col-sm-8 zeropadding">
                            @if(!empty($company->actual_domain))
                                <input type="text" class="link_field" name="country" value="{{$company->actual_domain}}?affiliate_id={{Auth::user()->affiliate_id}}" id="myPurchaseLink" readonly>
                            @else
                                <input type="text" class="link_field" name="country" value="{{env('APP_ALT_DOMAIN')}}?affiliate_id={{Auth::user()->affiliate_id}}" id="myPurchaseLink" readonly>
                            @endif
                        </div>
                        <div class="col-md-2 col-xs-6 col-sm-2">
                            ...
                            <div class="modal-body">
                                <form method="post" action="{{url('purchaseLink')}}">
                                    ...
                                    <div class="form-group col-sm-12">
                                        ...
                                        <input type="hidden" name="link" value="{{$company->actual_domain}}?affiliate_id={{Auth::user()->company_id}}">
                                    </div>
                                    <div class="form-group col-sm-12">
