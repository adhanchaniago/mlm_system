        ...
        <div class="col-md-12 stripe-pay_section">
            ...
            <div class="panel">
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" id="payment-form" role="form" action="{!! URL('paymentWithStripe') !!}">
                        {{ csrf_field() }}
                        <center>
                                    ...
                                    <div class="modal-body stripe-modal-body">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="col-md-5">
                                                            <h4>{{trans('home.plan')}} </h4>
                                                        </div>
                                                        <div class="col-md-1">
                                                            <h4><b>:</b></h4>
                                                        </div>
                                                        <div class="col-md-5 payment-detail">
                                                            <h4>{{$plan->name}}</h4>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3"></div>
                                                    ...
                                                    <div class="col-md-7">
                                                        <center>
                                                            <button type="submit" id="paywithStripe"
                                                                    class="btn btn-save-level btn-row">{{trans('home.proceed_to_pay')}}</button>
                                                        </center>
                                                    </div>
                                                    <div class="col-md-3"></div>
                                                </div>
