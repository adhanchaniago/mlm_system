    ...
    <div class="register-box-body affliate-page-body">
        ...
        <form method="post" enctype="multipart/form-data" action="{{ url('/register/affliate') }}">
            ...
            <div class="form-group has-feedback{{ $errors->has('name') ? ' has-error' : '' }}">
                ...
                <input type="text" class="form-control" name="name" value="{{ old('name') }}" placeholder="{{trans('affiliate.register_name')}}">
            ...
            <div class="form-group has-feedback{{ $errors->has('phone') ? ' has-error' : '' }}">
                ...
                <input type="text" class="form-control" name="phone" value="{{ old('phone') }}" placeholder="{{trans('affiliate.register_phone')}}">
            ...
            <div class="form-group has-feedback{{ $errors->has('email') ? ' has-error' : '' }}">
                ...
                <input type="email" class="form-control" name="email" value="{{ old('email') }}" placeholder="{{trans('affiliate.register_email')}}">
            ...
            <div class="form-group has-feedback{{ $errors->has('password') ? ' has-error' : '' }}">
                ...
                <input type="password" class="form-control" name="password" placeholder="{{trans('affiliate.register_psw')}}">
            ...
            <div class="form-group has-feedback{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                ...
                <input type="password" name="password_confirmation" class="form-control" placeholder="{{trans('affiliate.register_confirm_psw')}}">
            ...
            <div class="form-group has-feedback{{ $errors->has('photo') ? ' has-error' : '' }}">
                ...
                <input type="file" class="form-control" name="photo" value="{{ old('photo') }}" placeholder="Logo" onchange="readURL(this)"> <br/>
            ...
            <div class="row">
                ...
                <div class="col-xs-8">
                    ...
                    <div class="checkbox icheck">
                        ...
                        <label>
                            ...
                            <input type="checkbox" required> {{trans('affiliate.terms1')}}<a href="#"> {{trans('affiliate.terms2')}}</a>
                ...
                <div class="col-xs-4">
                    ...
                    <button type="submit" class="btn btn-primary btn-block btn-flat">{{trans('affiliate.regbtn')}}</button>
